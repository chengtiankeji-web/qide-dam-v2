...
from sqlalchemy import (
    String, Text, Boolean, DateTime, ForeignKey, CheckConstraint, Index, text,
)
...
class Contact(Base):
    ...
    role_category: Mapped[Optional[str]] = mapped_column(String(64))
    department: Mapped[Optional[str]] = mapped_column(String(128))
    seniority_level: Mapped[Optional[str]] = mapped_column(String(64))
    ...
    wechat: Mapped[Optional[str]] = mapped_column(String(128))

    linkedin_url: Mapped[Optional[str]] = mapped_column(Text)
    social_handles: Mapped[Optional[dict]] = mapped_column(JSONB)
    ...
    opt_in_marketing_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True))
    ...
    ai_personality_profile: Mapped[Optional[dict]] = mapped_column(JSONB)
    ai_last_engagement_summary: Mapped[Optional[str]] = mapped_column(Text)
